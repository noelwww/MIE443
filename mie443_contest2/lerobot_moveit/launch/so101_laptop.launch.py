"""
SO101 Laptop Launch File (Distributed Setup - Laptop Side)
...
Run the companion launch file (so101_turtlebot.launch.py) on the TurtleBot4 first.

Usage:
    ros2 launch lerobot_moveit so101_laptop.launch.py

Requirements:
    - so101_turtlebot.launch.py running on TurtleBot4
    - Same ROS_DOMAIN_ID as TurtleBot4 (e.g., export ROS_DOMAIN_ID=0)
    - Network connectivity between laptop and TurtleBot4
"""
