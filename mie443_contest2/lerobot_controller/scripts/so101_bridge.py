...
class So101Bridge(Node):
    ...
    URDF_LIMITS = {
        ...
        "3": {"min": -1.74533, "max": 1.5708},    # -100° to +90° (asymmetric)
    ...
    def __init__(self):
        ...
        self.declare_parameter('camera_index', 0)  # /dev/video0, /dev/video1, etc.
        ...
        # OpenCVCameraConfig uses camera index (0, 1, 2...) corresponding to /dev/video0, /dev/video1, etc.
        # Using native resolution, will resize in software when capturing
        camera_config = {
        ...
        # Lock for thread-safe robot access
        self.robot_lock = threading.Lock()

        # Current joint positions in RADIANS (for ROS)
